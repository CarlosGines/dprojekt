 ...
 * update the last read time of a {@link DecModel}.
 */
@PerActivity
public class UpdateDecReadTimeUseCase extends UseCase {
    ...
    @Inject
    public UpdateDecReadTimeUseCase(DecRepository decRepository, ThreadExecutor threadExecutor,
     ...
     *
     * @param decId ID of the Decision we are updating.
    ...
    protected Observable buildUseCaseObservable() {
        return mDecRepository.updateDecReadTime(mDecId, mIsPreview);
    }
}
