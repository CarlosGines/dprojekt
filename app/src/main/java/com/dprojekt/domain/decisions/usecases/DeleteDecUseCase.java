 ...
 * delete a {@link DecModel}
 */
@PerActivity
public class DeleteDecUseCase extends UseCase {
    ...
    @Inject
    public DeleteDecUseCase(DecRepository decRepository, ThreadExecutor threadExecutor,
     ...
     *
     * @param decId ID of the Decision we are deleting.
    ...
    protected Observable buildUseCaseObservable() {
        return mDecRepository.deleteDec(mDecId, mIsPreview);
    }
}
