 ...
 * close a {@link DecModel}, so that it will not accept more responses.
 */
@PerActivity
public class CloseDecUseCase extends UseCase {
    ...
    @Inject
    public CloseDecUseCase(DecRepository decRepository, ThreadExecutor threadExecutor,
     ...
     *
     * @param decId ID of the Decision we are closing.
    ...
    protected Observable buildUseCaseObservable() {
        return mDecRepository.closeDec(mDecId, mIsPreview);
    }
}
